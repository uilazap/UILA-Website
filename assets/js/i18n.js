...
(function () {
  ...
  const translations = {
    en: {
      ...
      'services.smartcontract.title': 'Smart Contract Audits',
      'services.smartcontract.desc':  'Code review and security audits for smart contracts on Bitcoin, Liquid, and ERC \u2014 protocol-level analysis, vulnerability disclosure, and remediation guidance.',
      'services.smartcontract.tag':   'Web3',
    ...
    es: {
      ...
      'services.smartcontract.title': 'Auditorías de Smart Contracts',
      'services.smartcontract.desc':  'Revisión de código y auditorías de seguridad para smart contracts en Bitcoin, Liquid y ERC \u2014 análisis a nivel de protocolo, divulgación de vulnerabilidades y guía de remediación.',
      'services.smartcontract.tag':   'Web3',
      'services.compliance.title': 'SOC 2 · PCI · ISO 27001',
